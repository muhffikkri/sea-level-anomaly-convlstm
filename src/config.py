...
# Strictly Synchronized with ICICoS REVISION MASTER RECAP PLAN (XGBoost Included)
# =========================================================================
...
# =========================================================================
PROJECT_ROOT = r"D:\Project\sea-level-anomaly-convlstm"
...
# Bounding box coordinates explicitly locked for a perfect 16 x 16 grid
# Covering macro-regional Central Java shoreline (109.5°E - 111.5°E)
# =========================================================================
MIN_LON = 109.5
MAX_LON = 111.5

# Catatan: Aturan koordinat selatan di belahan bumi selatan memakai nilai negatif
MIN_LAT = -8.0  
MAX_LAT = -6.0  
...
# =========================================================================
# CHRONOLOGICAL TEMPORAL SPLIT (UPDATED PER REVIEWER RECAP)
# Strict calendar boundaries to prevent future data temporal leakage
